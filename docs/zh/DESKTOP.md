...
| GET | `/v1/me/engine` | 内核、库路径、live pull 间隔/上次 tick、已安装连接器、未安装目录。`detail=0` 跳过 catalog 探测和 attempt 列表，仍带 `inbox_digest` |
