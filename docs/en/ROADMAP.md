...
Ship an open, **local-first** processing loop for one principal. Push and pull
ingest are equal citizens; the product transforms information — it does not
originate channel content.
