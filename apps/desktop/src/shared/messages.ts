...
export const en = {
  ...
  "engine.title": "Engine",
  "engine.lead":
    "Local store, connectors, and assistants. Enabled connectors pull while this computer is running. Open is current work; coverage is every conversation found so far.",
  ...
  "sync.noneFound": "No conversations found yet",
  "sync.coverage":
    "Found {discovered} · seeded {seeded} · backfilling {backfilling}",
  "sync.off": "off",
...
export const zh: Record<MessageKey, string> = {
  ...
  "engine.title": "引擎",
  "engine.lead":
    "本机数据、连接器和助手。本机在跑时，已启用的连接器会自己拉消息。进行中只看待办；同步覆盖是已发现的全部会话。",
  ...
  "sync.noneFound": "尚未发现会话",
  "sync.coverage": "已发现 {discovered} · 已播种 {seeded} · 回填中 {backfilling}",
  "sync.off": "已关闭",
