...
export const zh: Record<MessageKey, string> = {
  ...
  "recipes.title": "规则",
  "recipes.lead":
    "定一条规则：这类工作一出现，就交给这个执行器。对上的会话会进当前工作。你点开始，执行器负责做完。聊天里回一句不算做完。",
  "recipes.howTitle": "怎么用",
  "recipes.step1Title": "创建规则",
  "recipes.step1Body": "看所有任务、某个渠道的任务，或某一条会话，然后选执行器。",
  ...
  "recipes.bindHint": "在当前工作打开一条会话，点「绑定规则」，这里就会填上。",
  "recipes.runWith": "用谁来跑",
  "recipes.absentee": "这个执行器在后台跑，停下来后工单关闭。",
  "recipes.name": "名称",
  "recipes.writeBackCheck": "做完后，把结果发回原来的会话",
  "recipes.enabledCheck": "启用这条规则",
  "recipes.advanced": "高级",
  "recipes.facet": "再限定会话类型",
  ...
  "recipes.saveError": "规则保存失败",
  "recipes.deleteError": "规则删除失败",
  "recipes.errThread": "先在当前工作打开一条会话，再点「绑定规则」。",
  "recipes.errSource": "请选择这条规则要看的来源。",
  "recipes.errScope": "规则必须看所有任务、某个渠道的任务，或一条会话。",
  "recipes.suggestedThread": "{title} → {executor}",
  ...
  "recipes.whenNone": "没有具体条件，不会自动开跑",
